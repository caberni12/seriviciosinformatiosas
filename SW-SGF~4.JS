const SGF_CACHE='efleet-static-4.4.29-geo-checkin-gate';
const PRECACHE=[
  ...
  './menu-principal.css','./sgf-final-4.3.44.css','./efleet-palette.4386.css','./efleet-lightblue.4388.css','./login-r8245.css','./efleet-responsive-geocerca.4428.css','./sgf-performance.4429.js','./sgf-module.4428.js','./sgf-shell.4427.js',
  './panel-principal.html','./rutas.html','./operaciones.html','./checkin-vehicular.html','./vehiculos.html','./conductores.html',
  './geo-local.html','./geo-local-admin.html','./mapa-geo-local.html','./kpi-geo-locales.html','./malla-turnos.html','./geo-local.4408.css','./geo-local-common.4409.js','./geo-local-common.4413.js','./mapa.js'
];
