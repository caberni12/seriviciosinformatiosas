const SGF_CACHE='efleet-static-4.3.90-geo-admin-date-filter';
const PRECACHE=[
  ...
  './geo-local.html','./geo-local-admin.html','./mapa-geo-local.html','./kpi-geo-locales.html','./malla-turnos.html','./geo-local.4389.css','./geo-local-common.4390.js','./mapa.js'
];
