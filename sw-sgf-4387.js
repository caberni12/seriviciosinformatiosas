const SGF_CACHE='efleet-static-4.3.92-geo-plan-acumulativo-check';
const PRECACHE=[
  ...
  './geo-local.html','./geo-local-admin.html','./mapa-geo-local.html','./kpi-geo-locales.html','./malla-turnos.html','./geo-local.4392.css','./geo-local-common.4392.js','./mapa.js'
];
