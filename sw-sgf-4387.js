const SGF_CACHE='efleet-static-4.4.01-geo-plan-ui';
const PRECACHE=[
  ...
  './geo-local.html','./geo-local-admin.html','./mapa-geo-local.html','./kpi-geo-locales.html','./malla-turnos.html','./geo-local.4401.css','./geo-local-common.4401.js','./mapa.js'
];
