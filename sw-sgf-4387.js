const SGF_CACHE='efleet-static-4.4.00-geo-calendar';
const PRECACHE=[
  ...
  './geo-local.html','./geo-local-admin.html','./mapa-geo-local.html','./kpi-geo-locales.html','./malla-turnos.html','./geo-local.4392.css','./geo-local-common.4400.js','./mapa.js'
];
