const SGF_CACHE='efleet-static-4.3.91-geo-modal-size';
const PRECACHE=[
  ...
  './geo-local.html','./geo-local-admin.html','./mapa-geo-local.html','./kpi-geo-locales.html','./malla-turnos.html','./geo-local.4391.css','./geo-local-common.4390.js','./mapa.js'
];
