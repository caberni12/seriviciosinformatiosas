(()=>{
  ...
  async function registrarSW(){
    try{
      ...
      const reg=await navigator.serviceWorker.register('./sw-sgf-4386.js',{scope:'./',updateViaCache:'none'});
  ...
  if(/(?:^|\/)index\.html$/.test(location.pathname)||location.pathname.endsWith('/'))link('prefetch','main.html?v=4.3.86','document');
